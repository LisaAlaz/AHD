    ...
    return (
      <div className="sat-container">
         ...
         <div className='main-text-container'>
           ...
           >
            <p>
              Self-Attachment Technique (SAT) is a self-administrable intervention rooted in Attachment Theory for improving mental health in both the clinical and non-clinical populations. According to the Dynamic Maturational Model (DMM) of attachment and adaptation, while the style of attachment developed in early childhood with the primary caregiver creates a pathway for personality development across the lifespan, an individual’s attachment style can still change in adulthood, as the adult can earn secure attachment for example while connecting with a romantic partner, friend, mentor, or psychotherapist (this is called “reorganisation” strategy).
              <br/><br/>
              SAT reformulates the evolutionary optimal parent-child interaction as a self-administrable action programme - in which the user role-plays both the care-seeker and the care-giver - aiming to kick-start and accelerate DMM's reorganization strategy for earning emotion self-regulation and secure attachment. In SAT, the individual's mindset and behaviour are viewed as the interaction of two distinct actors: the childhood self and the adult self. The childhood self, mentally depicted by the individual’s childhood photos (or a VR avatar created from such photos), represents the emotional self, which is usually dominant when the individual is under stress. The adult self, on the other hand, represents the rational self which is usually dominant in the absence of stress. 
              <br/><br/>
              SAT consists of a series of exercises that are practised by an individual on their own, for 30 minutes a day over an eight-week period. In a recent pilot study, SAT has demonstrated a huge effect size on a population of chronically depressed and/or anxious Iranian women when evaluating GAD-7 and PHQ-9 pre and post-intervention, including a 12-week follow-up test.
            </p>
           </Typography>
         </div>
      </div>
